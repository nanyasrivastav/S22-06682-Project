...
print(f'\n    Datafiles in the uploaded directory include: {glob.glob("./data/*.json")}')
...
if num_files == "S":
    print(
        "\n\n    Please run the 'display_one.py' command\n    NOTE: Required arguments include path to datafile and an optional argument includes entering the number of rows to print."
    )
else:
    print(
        "\n\n    Please run the 'display_all.py' command\n    NOTE: Required arguments include path to all datafiles and an optional argument includes entering the number of rows to print for all inputted datafiles."
    )
